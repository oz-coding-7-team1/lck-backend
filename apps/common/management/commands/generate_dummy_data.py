    ...
    def handle(self, *args: Any, **kwargs: Any) -> None:  # ✅ 함수 타입 추가
        ...
        for name in team_names:
            team, created = Team.objects.get_or_create(
                name=name,
                defaults={"social": random_social()},  # ✅ 타입 힌트 추가된 함수 사용
            )
            teams.append(team)

        self.stdout.write(self.style.SUCCESS("✅ Created or retrieved 10 teams"))

        # 2️⃣ 팀당 5명의 선수 생성 (각 포지션 1명씩)
        ...
        for team in teams:
            ...
            for _ in range(5):
                ...
                Player.objects.create(
                    ...
                    social=random_social(),  # ✅ 타입 힌트 추가된 함수 사용
