...
# 팀 정보를 저장하는 모델
class Team(BaseModel, SoftDeleteModel):  # type: ignore
    # 팀 이름(최대 30글자, 중복불가)
...
# 팀 일정을 저장하는 모델
class TeamSchedule(BaseModel, SoftDeleteModel):  # type: ignore
...
# 팀 구독 정보를 저장하는 모델
class TeamSub(BaseModel, SoftDeleteModel):  # type: ignore
...
# 팀 이미지 정보를 저장하는 모멜
class TeamImage(BaseModel, SoftDeleteModel):  # type: ignore
    # 팀에 해당하는 이미지
...
# # 팀 관련 태그 정보를 저장하는 모델
# class TeamTags(BaseModel, SoftDeleteModel):  # type: ignore
#     # 태그명
